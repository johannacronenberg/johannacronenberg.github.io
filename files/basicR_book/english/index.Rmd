...
- Download and install the [Software R](https://ftp.fau.de/cran/). The latest version is currently `4.2.x` (February 2023).
...
R Markdown was used to create the HTML document that you are currently reading.
