...
- Laden Sie die [Statistik-Software R](https://ftp.fau.de/cran/) herunter und installieren Sie sie. Die neueste Version ist derzeit `4.2.x` (Stand: Februar 2023).
...
Eine Session beginnt, wenn man R bzw. RStudio startet bzw. wenn man ein Projekt öffnet. Man beendet eine Session entweder mit `Session > Quit Session` in der Werkzeugleiste oder mit `Strg+Q` bzw. `Ctrl+Q` oder mit `q()`. Die Session endet außerdem automatisch, wenn Sie RStudio schließen. 
